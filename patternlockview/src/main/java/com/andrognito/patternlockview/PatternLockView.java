...
public class PatternLockView extends View {
    ...
    private void initView() {
        ...
        mPathPaint.setColor(Color.parseColor("#0AC4DF"));
    ...
    private void drawCircle(Canvas canvas, float centerX, float centerY,
        ...
        mDotPaint.setColor(Color.parseColor("#0AC4DF"));
        mDotPaint.setStyle(Paint.Style.FILL);
        mDotPaint.setAlpha((int) (alpha * 255));
        canvas.drawCircle(centerX, centerY, (float) (size / 1.2), mDotPaint);

        mDotPaint.setStyle(Paint.Style.STROKE);
        mDotPaint.setStrokeWidth(5); // set stroke width
        mDotPaint.setColor(Color.parseColor("#0AC4DF")); // set stroke color
        canvas.drawCircle(centerX, centerY,
                (float) (size * 1.2), mDotPaint);
    }
